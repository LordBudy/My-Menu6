...
class DishDataSource {
    // Имитируем локальный источник данных (в реальном приложении это может быть чтение из файла)
    fun getLocalDishes(): List<DishEntity> {
        return listOf(
            DishEntity(
                1,
            ...
            DishEntity(
                6,
                "https://100foto.club/uploads/posts/2023-01/1672836368_11-100foto-club-p-trubochki-iz-vetchini-s-nachinkoi-18.jpg",
                "Рулеты из ветчины",
                400.0,
            ...
            DishEntity(
                9,
                "https://recettessimples.fr/images/Ratatouille_Assiette_1.jpg",
                "Рататуй",
                175.0,
